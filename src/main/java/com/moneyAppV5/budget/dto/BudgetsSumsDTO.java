...
public class BudgetsSumsDTO
{
    ...
    public BudgetsSumsDTO() {
    }

    public BudgetsSumsDTO(BudgetDTO highestSumBudget, double highestSum, BudgetDTO lowestSumBudget, double lowestSum) {
